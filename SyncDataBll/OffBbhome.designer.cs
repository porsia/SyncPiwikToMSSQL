...
namespace SyncDataBll
{
	...
	[Table(Name="dbo.Piwik_ColumnWord")]
    ...
    partial void OntypeChanged();
		...
		[Column(Storage="_refferurl", DbType="VarChar(2000) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_refferurlUTF", DbType="VarChar(2000) NOT NULL", CanBeNull=false)]
